...
import SSHorarios.SSHorariosFacade;
import SSUtilizadores.UtilizadorFacade;
...
public class Main {
    public static void main(String[] args){
        ...
        SSHorariosFacade horariosFacade = new SSHorariosFacade(utilizadoresFacade.getAlunos());
                ...
                while(terminar_sessao == 0){
                    ...
                    switch (escolha) {
                        ...
                        case 6:
                            ...
                            System.out.println(("Horários pessoais gerados\n"));
                            break;
                        case 7:
                            System.out.print("Insira o número do aluno que deseja: ");
                            int nAluno = scanner.nextInt();
                            System.out.println(utilizadoresFacade.getAlunos().get(nAluno).getHorario());
                            scanner.nextLine();
                            break;
                        case 8:
                            System.out.print("Insira o número do aluno que deseja: ");
                            ...
                            Utilizador aluno = utilizadoresFacade.getAlunos().get(nrAluno);
                            horariosFacade.efetuaTroca(aluno.getNumero(), (uc + "_" + turno_antigo), (uc + "_" + turno_novo));
                            horariosFacade.atualizaHorario(aluno, (uc + "_" + turno_antigo), (uc + "_" + turno_novo));
                            break;
                        case 9:
                            ...
                            if(hasEstatuto){  //pode trocar turnos
                                ...
                                switch(opcao){
                                    case 1:
                                        ...
                                        break;
                                    case 2:
                                        System.out.println(aluno.getHorario().toString());
                                        break;
                                    case 3:
